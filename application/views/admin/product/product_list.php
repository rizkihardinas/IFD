...
<div id="smartwizard-2" class="smartwizard-example sw-main sw-theme-default">
  <ul class="nav nav-tabs step-anchor">
    ...
    <li class="nav-item clickable"> <a href="<?php echo site_url('admin/product/staff_dashboard/');?>" data-link-data="<?php echo site_url('admin/product/staff_dashboard/');?>" class="mb-3 nav-link hrsale-link"> <span class="sw-done-icon ion ion-md-speedometer"></span> <span class="sw-icon ion ion-md-speedometer"></span> <?php echo $this->lang->line('hr_staff_dashboard_title');?>
    ...
    <li class="nav-item active"> <a href="<?php echo site_url('admin/product/');?>" data-link-data="<?php echo site_url('admin/product/');?>" class="mb-3 nav-link hrsale-link"> <span class="sw-done-icon fas fa-user-friends"></span> <span class="sw-icon fas fa-user-friends"></span> <?php echo $this->lang->line('dashboard_product');?>
      <div class="text-muted small"><?php echo $this->lang->line('xin_set_up');?> <?php echo $this->lang->line('dashboard_product');?></div>
      </a> </li>
    <?php } ?>
...
<div id="filter_hrsale" class="collapse add-formd <?php echo $get_animate;?>" data-parent="#accordion" style="">
  <div class="ui-bordered px-4 pt-4 mb-4 mt-3">
    ...
    <?php echo form_open('admin/product/product_list', $attributes, $hidden);?>
    <?php
            $data = array(
              'type'        => 'hidden',
              'name'        => 'date_format',
  ...
  <div id="accordion">
    ...
    <div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
      <div class="card-body">
        ...
        <?php echo form_open_multipart('admin/product/add_employee', $attributes, $hidden);?>
        <div class="form-body">
          <div class="row">
            <div class="col-md-6">
              <div class="row">
...
<?php if($user_info[0]->user_role_id==1){ ?>
<div class="card">
  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong><?php echo $this->lang->line('xin_list_all');?></strong> <?php echo $this->lang->line('xin_product');?></span>
    <div class="card-header-elements ml-md-auto"> <a href="<?php echo site_url('admin/product/hr/');?>" class="text-dark collapsed">
      <button type="button" class="btn btn-xs btn-primary"> <span class="ion ion-ios-cog"></span> <?php echo $this->lang->line('left_product_directory');?></button>
      ...
      </a> <a href="<?php echo site_url('admin/reports/product/');?>" class="text-dark collapsed">
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><?php echo $this->lang->line('xin_product_id');?></th>
            <th width="200"><i class="fa fa-user"></i> <?php echo $this->lang->line('xin_product_full_name');?></th>
  ...
  <div class="col-md-12"> 
    ...
    <div class="card">
      <ul class="nav nav-tabs">
            ...
            <?php echo $this->lang->line('xin_list_all');?> <?php echo $this->lang->line('xin_product');?></a> </li>
			<?php } ?>
            <?php
